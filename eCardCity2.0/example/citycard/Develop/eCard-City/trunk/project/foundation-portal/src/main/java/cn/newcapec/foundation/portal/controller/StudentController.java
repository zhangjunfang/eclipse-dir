...
public class StudentController extends MultiViewResource {
	...
	public String studentInfoUI(){
		return this.toView("foundation/student/pagelet/v1.0/studentinfo");
	}
	...
	@ResponseBody
	public String studentInfo(final ModelMap modelMap){
		PageContext.setPagesize(JSONTools.getInt(getJsonObject(), "pageSize"));
		Msg msg = new Msg();
		msg.setSuccess(true);
