...
/**
 * This is an object that contains data related to the CONSUME_PROCESSED table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="CONSUME_PROCESSED"
 */

public abstract class BaseConsumeProcessed  implements Comparable, Serializable {

	public static String REF = "ConsumeProcessed";
	 ...
	 */
	public BaseConsumeProcessed (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.ConsumeProcessed)) return false;
		else {
			cn.com.newcapec.citycard.common.po.ConsumeProcessed consumeProcessed = (cn.com.newcapec.citycard.common.po.ConsumeProcessed) obj;
			if (null == this.getId() || null == consumeProcessed.getId()) return false;
			else return (this.getId().equals(consumeProcessed.getId()));
		}
	}
