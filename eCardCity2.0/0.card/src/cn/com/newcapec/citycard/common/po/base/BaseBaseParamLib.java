...
/**
 * This is an object that contains data related to the BASE_PARAM_LIB table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="BASE_PARAM_LIB"
 */

public abstract class BaseBaseParamLib  implements Comparable, Serializable {

	public static String REF = "BaseParamLib";
	 ...
	 */
	public BaseBaseParamLib (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.BaseParamLib)) return false;
		else {
			cn.com.newcapec.citycard.common.po.BaseParamLib baseParamLib = (cn.com.newcapec.citycard.common.po.BaseParamLib) obj;
			if (null == this.getId() || null == baseParamLib.getId()) return false;
			else return (this.getId().equals(baseParamLib.getId()));
		}
	}
