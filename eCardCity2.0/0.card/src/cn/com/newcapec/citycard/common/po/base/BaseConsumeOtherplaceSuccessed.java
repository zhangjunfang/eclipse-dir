...
/**
 * This is an object that contains data related to the CONSUME_OTHERPLACE_SUCCESSED table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="CONSUME_OTHERPLACE_SUCCESSED"
 */

public abstract class BaseConsumeOtherplaceSuccessed  implements Comparable, Serializable {

	public static String REF = "ConsumeOtherplaceSuccessed";
	...
	// constructors
	public BaseConsumeOtherplaceSuccessed () {
		initialize();
	}
	 ...
	 */
	public BaseConsumeOtherplaceSuccessed (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.ConsumeOtherplaceSuccessed)) return false;
		else {
			cn.com.newcapec.citycard.common.po.ConsumeOtherplaceSuccessed consumeOtherplaceSuccessed = (cn.com.newcapec.citycard.common.po.ConsumeOtherplaceSuccessed) obj;
			if (null == this.getId() || null == consumeOtherplaceSuccessed.getId()) return false;
			else return (this.getId().equals(consumeOtherplaceSuccessed.getId()));
		}
	}
