...
/**
 * This is an object that contains data related to the MONEY_SAVE_SUCCESSED table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="MONEY_SAVE_SUCCESSED"
 */

public abstract class BaseMoneySaveSuccessed  implements Comparable, Serializable {

	public static String REF = "MoneySaveSuccessed";
	 ...
	 */
	public BaseMoneySaveSuccessed (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.MoneySaveSuccessed)) return false;
		else {
			cn.com.newcapec.citycard.common.po.MoneySaveSuccessed moneySaveSuccessed = (cn.com.newcapec.citycard.common.po.MoneySaveSuccessed) obj;
			if (null == this.getId() || null == moneySaveSuccessed.getId()) return false;
			else return (this.getId().equals(moneySaveSuccessed.getId()));
		}
	}
