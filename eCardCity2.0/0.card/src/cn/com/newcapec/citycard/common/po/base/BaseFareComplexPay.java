...
/**
 * This is an object that contains data related to the FARE_COMPLEX_PAY table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="FARE_COMPLEX_PAY"
 */

public abstract class BaseFareComplexPay  implements Comparable, Serializable {

	public static String REF = "FareComplexPay";
	 ...
	 */
	public BaseFareComplexPay (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.FareComplexPay)) return false;
		else {
			cn.com.newcapec.citycard.common.po.FareComplexPay fareComplexPay = (cn.com.newcapec.citycard.common.po.FareComplexPay) obj;
			if (null == this.getId() || null == fareComplexPay.getId()) return false;
			else return (this.getId().equals(fareComplexPay.getId()));
		}
	}
