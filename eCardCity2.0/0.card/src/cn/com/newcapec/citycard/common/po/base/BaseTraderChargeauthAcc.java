...
/**
 * This is an object that contains data related to the TRADER_CHARGEAUTH_ACC table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="TRADER_CHARGEAUTH_ACC"
 */

public abstract class BaseTraderChargeauthAcc  implements Comparable, Serializable {

	public static String REF = "TraderChargeauthAcc";
	 ...
	 */
	public BaseTraderChargeauthAcc (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	// fields
	private java.lang.String dptcode;
	...
	/**
	 * Return the value associated with the column: DPTCODE
	 */
	...
	/**
	 * Set the value related to the column: DPTCODE
	 * @param dptcode the DPTCODE value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.TraderChargeauthAcc)) return false;
		else {
			cn.com.newcapec.citycard.common.po.TraderChargeauthAcc traderChargeauthAcc = (cn.com.newcapec.citycard.common.po.TraderChargeauthAcc) obj;
			if (null == this.getId() || null == traderChargeauthAcc.getId()) return false;
			else return (this.getId().equals(traderChargeauthAcc.getId()));
		}
	}
