...
/**
 * This is an object that contains data related to the CONSUME_OTHERPLACE_DOUBT table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="CONSUME_OTHERPLACE_DOUBT"
 */

public abstract class BaseConsumeOtherplaceDoubt  implements Comparable, Serializable {

	public static String REF = "ConsumeOtherplaceDoubt";
	...
	public static String PROP_ERRCODE = "errcode";
	...
	// constructors
	public BaseConsumeOtherplaceDoubt () {
		initialize();
	}
	 ...
	 */
	public BaseConsumeOtherplaceDoubt (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String localcstaccfc;
	 ...
	 */
	public java.lang.String getLocalcstaccfc () {
	 ...
	 */
	public void setLocalcstaccfc (java.lang.String localcstaccfc) {
	...
	/**
	 * Return the value associated with the column: ERRCODE
	 */
	...
	/**
	 * Set the value related to the column: ERRCODE
	 * @param errcode the ERRCODE value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.ConsumeOtherplaceDoubt)) return false;
		else {
			cn.com.newcapec.citycard.common.po.ConsumeOtherplaceDoubt consumeOtherplaceDoubt = (cn.com.newcapec.citycard.common.po.ConsumeOtherplaceDoubt) obj;
			if (null == this.getId() || null == consumeOtherplaceDoubt.getId()) return false;
			else return (this.getId().equals(consumeOtherplaceDoubt.getId()));
		}
	}
