...
/**
 * This is an object that contains data related to the MONEY_SAVE_FAILURE table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="MONEY_SAVE_FAILURE"
 */

public abstract class BaseMoneySaveFailure  implements Comparable, Serializable {

	public static String REF = "MoneySaveFailure";
	 ...
	 */
	public BaseMoneySaveFailure (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.MoneySaveFailure)) return false;
		else {
			cn.com.newcapec.citycard.common.po.MoneySaveFailure moneySaveFailure = (cn.com.newcapec.citycard.common.po.MoneySaveFailure) obj;
			if (null == this.getId() || null == moneySaveFailure.getId()) return false;
			else return (this.getId().equals(moneySaveFailure.getId()));
		}
	}
