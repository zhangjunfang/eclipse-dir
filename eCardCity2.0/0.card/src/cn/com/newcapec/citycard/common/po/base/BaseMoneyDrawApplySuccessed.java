...
/**
 * This is an object that contains data related to the MONEY_DRAW_APPLY_SUCCESSED table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="MONEY_DRAW_APPLY_SUCCESSED"
 */

public abstract class BaseMoneyDrawApplySuccessed  implements Comparable, Serializable {

	public static String REF = "MoneyDrawApplySuccessed";
	...
	// constructors
	public BaseMoneyDrawApplySuccessed () {
		initialize();
	}
	 ...
	 */
	public BaseMoneyDrawApplySuccessed (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.MoneyDrawApplySuccessed)) return false;
		else {
			cn.com.newcapec.citycard.common.po.MoneyDrawApplySuccessed moneyDrawApplySuccessed = (cn.com.newcapec.citycard.common.po.MoneyDrawApplySuccessed) obj;
			if (null == this.getId() || null == moneyDrawApplySuccessed.getId()) return false;
			else return (this.getId().equals(moneyDrawApplySuccessed.getId()));
		}
	}
