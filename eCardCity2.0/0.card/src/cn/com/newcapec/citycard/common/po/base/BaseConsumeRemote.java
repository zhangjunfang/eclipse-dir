...
/**
 * This is an object that contains data related to the CONSUME_REMOTE table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="CONSUME_REMOTE"
 */

public abstract class BaseConsumeRemote  implements Comparable, Serializable {

	public static String REF = "ConsumeRemote";
	 ...
	 */
	public BaseConsumeRemote (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.ConsumeRemote)) return false;
		else {
			cn.com.newcapec.citycard.common.po.ConsumeRemote consumeRemote = (cn.com.newcapec.citycard.common.po.ConsumeRemote) obj;
			if (null == this.getId() || null == consumeRemote.getId()) return false;
			else return (this.getId().equals(consumeRemote.getId()));
		}
	}
