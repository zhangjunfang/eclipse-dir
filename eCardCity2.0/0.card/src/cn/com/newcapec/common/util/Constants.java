...
public interface Constants {
	public static final String PICTURE_PHARMACY = "1";				//图片类别-药店
	public static final String PICTURE_MEDICINE = "2";				//图片类别-药品
	
	public static final String CONTENT_MEDICINE_NEWS = "医药资讯";	//医药资讯
	public static final Integer CONTENT_MEDICINE_NEWS_ID = 1;		//医药资讯ID
	public static final String CONTENT_BULLETIN = "系统公告";			//网站公告
	public static final Integer CONTENT_BULLETIN_ID = 2;			//网站公告ID
