...
<html>
    ...
    <body>
        ...
        <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td><img src="${path}/common/img/login01.jpg" width="920" height="244" /></td>
            </tr>
            <tr>
                <td class="login_bg" style="background-image:url(${path}/common/img/login02.jpg);">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="500">&nbsp;</td>
                            <td valign="middle">
                                <table width="280" border="0" cellspacing="0" cellpadding="0" style="font-size: 12px;">
                                    <tr align="left">
                                    	<td colspan="2">
            ...
            <tr>
                <td><img src="${path}/common/img/login03.jpg" width="920" height="133" /></td>
            </tr>
        </table>
        </form>
    </body>
