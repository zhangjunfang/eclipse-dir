...
var webFXTreeConfig = {
    rootIcon        : '../common/plugins/tabpage/img/foldericon.gif',
    openRootIcon    : '../common/plugins/tabpage/img/openfoldericon.gif',
    folderIcon      : '../common/plugins/tabpage/img/foldericon.gif',
    openFolderIcon  : '../common/plugins/tabpage/img/openfoldericon.gif',
    fileIcon        : '../common/plugins/tabpage/img/file.gif',
    iIcon           : '../common/plugins/tabpage/img/I.gif',
    lIcon           : '../common/plugins/tabpage/img/L.gif',
    lMinusIcon      : '../common/plugins/tabpage/img/Lminus.gif',
    lPlusIcon       : '../common/plugins/tabpage/img/Lplus.gif',
    tIcon           : '../common/plugins/tabpage/img/T.gif',
    tMinusIcon      : '../common/plugins/tabpage/img/Tminus.gif',
    tPlusIcon       : '../common/plugins/tabpage/img/Tplus.gif',
    blankIcon       : '../common/plugins/tabpage/img/blank.gif',
...
WebFXTreeItem.prototype.remove = function() {
    ...
    if ((prevSibling == parentNode) && !(parentNode.childNodes.length)) {
        ...
        //��ɾ��ֻ�и�ڵ��ʱ������ķ������쳣�����ԼӸ�try catch (hezhenfeng)
        try {
