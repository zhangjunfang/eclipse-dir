...
<html>
	...
	<body>
		...
		<!-- 工作区 -->
		<form action="${path}/system/moduleInfo_updateNext.action" method="post"
			onSubmit="return fCheckTheForm(this);">

			<input type="hidden" name="moduleInfo.pid"
				value="<s:property value="parentId" />" />
			<input type="hidden" name="moduleInfo.id"
				value="<s:property value="moduleInfo.id" />" />
					...
					<td>
						<table align="center" class="table-form">
							...
							<tr>
								...
								<td>
									<input name="moduleInfo.permName" type="text" value="<s:property value="moduleInfo.permName"/>" Maxlength="25" Isblank="0" Tip="模块名称" onblur="fCheckModuleInfoIsRepeat(this,<s:property value="parentId" />,'<s:property value="moduleInfo.permName"/>')">
									<span id="msg"></span>
							...
							<tr>
								...
								<td>
									<input name="moduleInfo.permUrl" type="text" value="<s:property value='moduleInfo.permUrl'/>" Isblank="1"
										Maxlength="80" Tip="访问地址">菜单或子菜单（非叶子节点）该项无须填写
								</td>
							</tr>
							<tr>
