...
//		detachedCriteria.addOrder(Order.asc(TOrgRole.PROP_ID));
		return getCountsByCriteria(detachedCriteria);
	}
	...
	public List getRoleInfoNameValueList() {
		return getListByHQL(getRoleInfoNameValueList);
	}
	...
	public List<NameValue> getUserHaveRoleInfoListByUserId(Integer userId){
		return getListByHQL(getUserHaveRoleInfoListByUserId,new Object[]{userId});
	}
	...
	public List<NameValue> getUserNoRoleInfoListByUserId(Integer userId){
		return getListByHQL(getUserNoRoleInfoListByUserId,new Object[]{userId});
	}
