...
/**
 * This is an object that contains data related to the MONEY_SAVE_UNSETTLED table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="MONEY_SAVE_UNSETTLED"
 */

public abstract class BaseMoneySaveUnsettled  implements Comparable, Serializable {

	public static String REF = "MoneySaveUnsettled";
	 ...
	 */
	public BaseMoneySaveUnsettled (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.MoneySaveUnsettled)) return false;
		else {
			cn.com.newcapec.citycard.common.po.MoneySaveUnsettled moneySaveUnsettled = (cn.com.newcapec.citycard.common.po.MoneySaveUnsettled) obj;
			if (null == this.getId() || null == moneySaveUnsettled.getId()) return false;
			else return (this.getId().equals(moneySaveUnsettled.getId()));
		}
	}
