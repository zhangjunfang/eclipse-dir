...
import cn.com.newcapec.citycard.common.po.base.BaseConsumeRemoteSuccessed;



public class ConsumeRemoteSuccessed extends BaseConsumeRemoteSuccessed {
	private static final long serialVersionUID = 1L;

/*[CONSTRUCTOR MARKER BEGIN]*/
	public ConsumeRemoteSuccessed () {
		super();
	}
	 ...
	 */
	public ConsumeRemoteSuccessed (java.lang.String id) {
		super(id);
	}
