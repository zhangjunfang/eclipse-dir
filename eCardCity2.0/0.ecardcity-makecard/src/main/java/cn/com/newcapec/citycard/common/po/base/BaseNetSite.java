...
/**
 * This is an object that contains data related to the NET_SITE table.
...
public abstract class BaseNetSite  implements Comparable, Serializable {

	public static String REF = "NetSite";
	 ...
	 */
	public BaseNetSite (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.NetSite)) return false;
		else {
			cn.com.newcapec.citycard.common.po.NetSite netSite = (cn.com.newcapec.citycard.common.po.NetSite) obj;
			if (null == this.getId() || null == netSite.getId()) return false;
			else return (this.getId().equals(netSite.getId()));
		}
	}
