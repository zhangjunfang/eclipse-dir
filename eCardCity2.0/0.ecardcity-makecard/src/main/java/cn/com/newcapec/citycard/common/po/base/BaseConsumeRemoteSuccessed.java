...
/**
 * This is an object that contains data related to the CONSUME_REMOTE_SUCCESSED table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="CONSUME_REMOTE_SUCCESSED"
 */

public abstract class BaseConsumeRemoteSuccessed  implements Comparable, Serializable {

	public static String REF = "ConsumeRemoteSuccessed";
	...
	// constructors
	public BaseConsumeRemoteSuccessed () {
		initialize();
	}
	 ...
	 */
	public BaseConsumeRemoteSuccessed (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.ConsumeRemoteSuccessed)) return false;
		else {
			cn.com.newcapec.citycard.common.po.ConsumeRemoteSuccessed consumeRemoteSuccessed = (cn.com.newcapec.citycard.common.po.ConsumeRemoteSuccessed) obj;
			if (null == this.getId() || null == consumeRemoteSuccessed.getId()) return false;
			else return (this.getId().equals(consumeRemoteSuccessed.getId()));
		}
	}
