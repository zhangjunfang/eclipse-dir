...
/**
 * This is an object that contains data related to the CHARGEAUTH table.
...
public abstract class BaseChargeauth  implements Comparable, Serializable {

	public static String REF = "Chargeauth";
	 ...
	 */
	public BaseChargeauth (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.Chargeauth)) return false;
		else {
			cn.com.newcapec.citycard.common.po.Chargeauth chargeauth = (cn.com.newcapec.citycard.common.po.Chargeauth) obj;
			if (null == this.getId() || null == chargeauth.getId()) return false;
			else return (this.getId().equals(chargeauth.getId()));
		}
	}
