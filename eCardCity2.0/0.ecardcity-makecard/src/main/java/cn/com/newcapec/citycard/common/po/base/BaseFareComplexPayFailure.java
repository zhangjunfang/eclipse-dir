...
/**
 * This is an object that contains data related to the FARE_COMPLEX_PAY_FAILURE table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="FARE_COMPLEX_PAY_FAILURE"
 */

public abstract class BaseFareComplexPayFailure  implements Comparable, Serializable {

	public static String REF = "FareComplexPayFailure";
	...
	// constructors
	public BaseFareComplexPayFailure () {
		initialize();
	}
	 ...
	 */
	public BaseFareComplexPayFailure (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.newcapec.citycard.common.po.FareComplexPayFailure)) return false;
		else {
			cn.com.newcapec.citycard.common.po.FareComplexPayFailure fareComplexPayFailure = (cn.com.newcapec.citycard.common.po.FareComplexPayFailure) obj;
			if (null == this.getId() || null == fareComplexPayFailure.getId()) return false;
			else return (this.getId().equals(fareComplexPayFailure.getId()));
		}
	}
