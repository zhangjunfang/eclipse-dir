 ...
 *
 */
@Table(name = "MONEY_SAVE_FAILURE")
@Entity
public class MoneySaveFailure extends CommonModel{
	private static final long serialVersionUID = -1735687717145765596L;
	...
	@Column(name="badrecid",length=1)
	private String badrecid;//坏账类型
	...
	public String getBadrecid() {
		return badrecid;
	}
	public void setBadrecid(String badrecid) {
