 ...
 */
@Table(name = "base_param_lib")
@Entity
public class ParamLib extends CommonModel {
    private static final long serialVersionUID = -9092581194981576901L;
    @Column(name = "p_lib_group", length = 32)
    private String p_lib_group;
    ...
    /**
     * @return the p_lib_group
     */
    public String getP_lib_group() {
        return p_lib_group;
    }
    /**
     * @param p_lib_group the p_lib_group to set
     */
    public void setP_lib_group(String p_lib_group) {
        this.p_lib_group = p_lib_group;
    }
    /**
     * @return the p_name
     */
