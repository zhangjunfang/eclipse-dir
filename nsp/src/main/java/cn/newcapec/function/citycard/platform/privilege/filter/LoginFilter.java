package cn.newcapec.function.citycard.platform.privilege.filter;
...
////*///	*//* 资源业务接口类 *//*
	static ResourceService resourceService = SpringConext.getApplicationContext().getBean(ResourceService.class);
//
	//本地缓存
