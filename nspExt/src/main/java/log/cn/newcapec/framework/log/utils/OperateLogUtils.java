...
public class OperateLogUtils {
	...
	private static OperateLogService operateLogService = (OperateLogService) SpringConext
			.getApplicationContext().getBean("operateLogService");
	...
	/**
	 * @return 是否实时提交日志，默认false，日志量大时，使用实时提交会很影响性能。
	 */
	...
	/**
	 * @return 日志非实时提交时，首次提交的延时时间，单位毫秒。
	 */
	...
	/**
	 * @return 日志非实时提交时，等待提交的间隔时间，单位毫秒。
	 */
