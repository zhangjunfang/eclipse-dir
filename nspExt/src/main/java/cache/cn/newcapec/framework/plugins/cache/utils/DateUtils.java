...
public class DateUtils {
	...
	/**
	 * 按指定格式获得当前日�? 返回�?个字符串 yyyyMMddHHmmss 比如: 2007�?10�?15�? 晚上9�?30�?20�?
	 * 就返�? 20071015213020
	 */
	...
	/**
	 * 得到以当前日期为标准的X�? X 为正，则是当前日期向后某�? X 为负，则是当前日期向前某�?
	 * **/
	...
	// }
	/**
	 * 判断 first 与second两个日期。 如果first在second之前，则true
	 * **/
	...
	/**
	 * 判断 first 与second两个日期。 first是否在second之后。 如: 2012-12-12 就在 2012-12-11之后
	 * **/
	...
	public static Date parse(String strDate) {
		return parse(strDate, new String[] { DEFALUT_DATE_PATTERN,
				DEFALUT_DATETIME_PATTERN });
	}
	...
	public static Date parse(String strDate, String[] aMasks) {
		if (StringUtils.notText(strDate))
			return null;
	...
	public static void main(String[] args) throws Exception {
		...
		// long l = dateDiff(DateIntervalType.DAY,
		// DateUtils.parse("2012-10-09"), DateUtils.parse("2012-10-09"));
		//
		...
		//
		// System.out.println(DateUtils.parse(ps,
		// DateUtils.DEFALUT_DATETIME_PATTERN));
	}

	public static void testMain() {
		// System.out.println(getNow());
		// System.out.println(dateDiff(DateIntervalTypeEnum.HOUR,
		// getNow(),getBeginOfToday()));
